...
interface DigitalMenuFormContentProps {
  selectedMenu: DigitalMenu | null // null when creating new menu
  menus: DigitalMenu[]
  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription>
          {isEditing ? "Actualiza los detalles de tu menú digital." : "Crea un nuevo menú digital para tu restaurante."}
        </DialogDescription>
      </DialogHeader>
      <form onSubmit={handleSubmit} className="grid gap-4 py-4">
        {/* Hidden field to indicate if this is a new menu */}
